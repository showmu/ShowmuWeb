...
!function ($) {
	...
	var TabDrop = function (element, options) {
		...
		if (options.align === "left")
		    this.dropdown = $('<li class="dropdown hide pull-left tabdrop"><a class="btn btn-danger dropdown-toggle" data-toggle="dropdown" href="#"><span class="display-tab"></span><b class="caret"></b></a><ul id="tabsMore" class="dropdown-menu"></ul></li>');
		else
		    this.dropdown = $('<li class="dropdown hide pull-right tabdrop"><a class="btn btn-danger dropdown-toggle" data-toggle="dropdown" href="#"><span class="display-tab"></span><b class="caret"></b></a><ul id="tabsMore" class="dropdown-menu"></ul></li>');
